...
CVRS - Construction Veterans Reducing Suicide — FFC-supported charity website (static, GitHub Pages).

This repository holds a fully localized static capture of the former WordPress site at
`cvrs-us.org`, migrated as part of the FFC Wave-1 WordPress-to-Pages program
...
- Deployed to GitHub Pages on the default URL:
  <https://freeforcharity.github.io/FFC-EX-cvrs-us.org/>
...
- Captured from the live WordPress site (Divi theme); same-origin assets and fonts localized; one dead LinkedIn logo image pruned.
